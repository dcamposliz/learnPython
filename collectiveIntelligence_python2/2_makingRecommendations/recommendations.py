...
listOfCritics = ['Lisa Rose', 'Gene Seymour', 'Michael Phillips', 'Claudia Puig', 'Mick LaSalle', 'Jack Matthews', 'Toby']

def compareEveryone():
  for critic_1 in listOfCritics:
    for critic_2 in listOfCritics:
      print "\n" + critic_1 + " " + critic_2
